...
| `/book-illustrate` | 3-5 | Ilustrações interiores — extração de cenas, prompts consistentes, plano de posicionamento |
...
| `illustrator` | Ilustrações interiores — extração de cenas, bíblia de estilo, geração de prompts |
